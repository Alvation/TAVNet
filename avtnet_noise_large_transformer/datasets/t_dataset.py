...
class AVTNetDataset(FairseqDataset):
    ...
    def __getitem__(self, index):
        ...
        return {"id": index, 'fid': fid, "label_list": labels, "label_st_list": st_labels}
    ...
    def collater(self, samples):
        ...
        targets_st_list, lengths_st_list, ntokens_st_list = self.collater_label(
            targets_st_by_label, self.label_processors[0].dictionary.index("</st_s>")
        )
    ...
    def collater_label(self, targets_by_label, eos=None):
