...
class AVTNetDeltamSeq2Seq(FairseqEncoderDecoderModel):
    def __init__(self, encoder, decoder, tgt_dict, cfg):
        ...
        self.freeze_finetune_updates = cfg.freeze_finetune_updates
        # load deltalm model
        deltalm_args = argparse.Namespace()
        
        deltalm_args = transformer_base_architecture(deltalm_args)
        ...
        self.deltalm_encoder = TransformerEncoder(deltalm_args, tgt_dict, deltalm_encoder_embed_tokens)
        self.deltalm_layernorm = LayerNorm(cfg.decoder_embed_dim)
    ...
    def forward(self, **kwargs):
        ...
        deltam_encoder_out["encoder_out"] = self.deltalm_layernorm(deltam_encoder_out["encoder_out"])
