...
#   common.user_dir=${user_dir} hydra.run.dir=${user_dir}/433h_data_idea2 \
#   common.tensorboard_logdir=${user_dir}/433h_data_idea2/tensorboard \
  
fairseq-hydra-train --config-dir ${user_dir}/conf --config-name train_base.yaml \
  task.data=${lrs3_root}/433h_data task.label_dir=${lrs3_root}/433h_data \
  task.tokenizer_bpe_model=${user_dir}/utils/spm.model \
  common.user_dir=${user_dir} hydra.run.dir=${user_dir}/433h_data_idea2 \
  common.tensorboard_logdir=${user_dir}/433h_data_idea2/tensorboard \
